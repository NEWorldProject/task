...
#include "event.h"
#ifdef __TASK_EVENT_IMPL_MACK_SEM
#include <cstdlib>
#include <mach/mach.h>
#include "spin_lock.h"
namespace task::__detail {
    ...
    void __notification_impl::__init() noexcept { __sem = new_sem_from_pool(); }
    
    void __notification_impl::__deinit() noexcept { restore_sem_to_pool(__sem); }
}
#endif
